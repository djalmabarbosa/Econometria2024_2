...
![Tabela com dados municipais](Tabela_dados_municipios.png){alt="Tabela com dados municipais"}
...
Para criar e alterar objetos no R utilizamos o símbolo \<-, chamado de
