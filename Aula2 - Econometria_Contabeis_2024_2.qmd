...
dados <- tibble(
  ...
  participacao_mercado = rexp(n, rate = 0.2), # Exponencial (assimétrica)
...
-   Vamos dar mais uma olhada nos dados, agora com a função *glimpse ()*, do tidyverse:
...
Vamos transformr a variável *presenca_internacional* em um fator:
